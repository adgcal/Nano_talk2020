...
-  As a matter of co-incidence, I just started a Calcutta Medical college collaboration.
- She joined the newly initiated  platelet aggregation project.
- She did an initial work on agonist thresholding and then switched over to nano-bio.
- Needness to say she did a pioneering work in the field of nanotoxicology
- Her investigtions proved the type and size of nanoparticles that would be safe for a nano-drug.
