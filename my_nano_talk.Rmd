...
- Nanotechnology has evolved as a result of some inherent shortcoming of related branches of science e.g., biology. 
...
# The Nanocentre proposal
The proposal for the nanocentre cameout in the next year - A signifcant portion of the proposal contained the small progress that we achieved in our lab at that time.
![](crnn_pad.png)
...
- Jaydeep was working on folding of a protein which most of the protein scientists avoid, but many medical biologists love 
- It was hemoglobin
...
- With the help of Dr. P.Sen who was in possession of copper nanoparticles (using top down ball mill methods) we attempted to strudy Hb folding using CuNP
...
- Ranjita cameout with an interesting obsevation that there is a **systematic but compensatory unfolding of protein**  it is subjected to synthtic glycation.
...
- The result was that different level of glycation led to different sizes of AuNP formation (showing different colors). 
...
- But the direct proof of formation of of extended structure was rare. 
...
- Shibsekhar made a direct measurement of the size of extended structure of Cyt C. 
- Eventually that  was also his entrypoint to the nanoworld. 
...
\small
- While this lab  was comfortable with protein problems and was getting intriguing results with nanoparticle protein interactions, a biologist joined. 
- She wanted to explore a hematological events, namely platelet aggregation, (a subject to which  I was just startted collaborating with the Calcutta Medical college (courtsey Dr. Prabir Lahiri & Dr. Utpal Chaudhuri).
...
- The other new finding was selectivity of the size distribution - some nano-sizes were more probable than others. 
...
- Role of static magnetic field. 

# 1.82 
![](PhD_Raja.png)

# 1.91
- Tamoghna was the first person in the lab to try carbon nanomaterial 
- He got himself trained in IIT Kanpur to an expert in carbon nanomaterial
- After some efforts he came up with the idea of studying interaction of SWNT and lipids. 
...
- He is still doing something related to nanotechnology of the cornea. 
...
- I am now describing the concluding part of my nanotour.
- It was Sanhita who started looking in nanointerface of biofilm 
- She started with conceptualizing a oxygen sensor 
- She then came up with the idea of introducing a nano-inspired synthetic biology. By conjugating the microbial surface with magnetic NP, and then using SMF. 
- She also made some interesting observation on interaction with biofilms with a 2D Dirac material (graphene) . 
...
- But we know that the plasmon resonance changes as the partcle size becomes smaller
...
\small
- Why there is Difference of the Absrobance and Fluorescence  detections system?
- Those who have tried to measure plasmon resonance using different detection system will relaize that we often get significant variations in the plasmonic frequency when we use spectrophotometer (abs based) as compared a fluorimeter (scattering based). 
...
- Existential;Will the technology will merge with other sister disciplines or it will retain an indepndent existence 
- How nanotechnology can merge with other trending disciplines like chip development and/or big data 
- How nanoscience can contribute to the emerging disciplinces of qunatum biology/qunatum computation. 
...
- We are poor in **nano-aerosol** interaction. It will be interesting to probe how nanoforms can be exploited in sanitizing the air quality or removing the undesirable toxicants from air. 
- Nanotechnology may be used in the **pulp and paper** industry
- **Medical textiles** for Nanofiber-based 'smart' dressings.
- Printed papers using **nanoparticle based electronic component** (inks of graphene, gold and silver being already available)
- We may use **nanomaterials for developing effective sanitations** (important post-covid step). 
- Deeper understanding of biomaterials nanomaterial interaction  would enable us to fabricate smarter sensors.  

# Gunther Stent's Prediction & a Ray og Hope 
...
- They tested the reset function of the system for reusability by dehybridizing all DNA assemblies after exchanging the buffer solution in the setup. 
