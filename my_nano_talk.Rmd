...
- The result was that different level of glycation led to different sizes of AuNP formation (shoing different colors). 
...
# 1.51
- Our first tryst with cancel cell nanoparticle interaction started with Hirak.
...
\end{equation}
where, $\chi_{nl}$ in the n-th root of the i-th order spherical Bessel function. </p>
**Cubic nanoparticle**:
...
\small
- Why there is Difference of the Absrobance and Fluoresence  detections system?
...
- Deeper understanding of biomaterials nanmaterial interaction interaction would enable us to make smarter sensors.  
# Gunther Stent's Prediction & a Ray og Hope 

- Gunther Stent predicted that our undestanding in molecular biology has come to saturation 
- We can only add information and no knowldge in molecular biology
- It was just after that the restriction enzymes were discovered and molecylar biology underwent a second revolution. 

# Nanosnart to NanoGate
