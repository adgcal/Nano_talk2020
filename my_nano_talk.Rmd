...
\small
- Right now an NEP convention is going on in the PMO office 
- One important aspect of NEP is bridging the gap between the traditional wisdom emerging technology.
- How nanotechnology is connected to tradition ?
  - Traditional drugs e.g., bhasmas (Dr. Jayesh Bellare) and kajal/surma are special nanoforms.
  - Iron utensils by tribals are known to be have an edge over over Al-utensils. Thanks to iron nanoforms.
  - The Inca guarded their gold mines, not because of love of gold but assumed that there are health benifits.
  - <https://edition.cnn.com/2017/11/10/world/wonder-list-bill-weir-peru-amazon-illegal-gold-mining/index.html> Gold rush that is destroying amazon.
  - The color of the butterfly wing are naturally occuring nanomaterial 
